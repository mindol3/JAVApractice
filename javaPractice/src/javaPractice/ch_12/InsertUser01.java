...
class DBInsert extends DB {
	private User setUser() {
		...
		do {
			...
			validateTemp = scanner.next(); // 입려값 저장
			
			validate = !validateTemp.equals("y"); // 입력값이 y가 아닌 경우 true, 같은 경우 false 반환
